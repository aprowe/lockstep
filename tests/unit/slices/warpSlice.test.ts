...
import { selectSortedOrig, selectSortedBeat, selectLinkedAnchorIds } from '../../../src/store/selectors'
...
function seedAnchor(store: ReturnType<typeof makeStore>, payload: { id: number; origTime: number; beatTime?: number }) {

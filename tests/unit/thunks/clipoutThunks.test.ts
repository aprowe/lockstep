...
describe('commitClipoutResize', () => {
  it('anchorLock=true, altKey=false, lock=beats → anchors RESCALE proportionally', () => {
    ...
    store.dispatch(commitClipoutResize({ id: 'r', inBeatTime: 10, outBeatTime: 18, altKey: false }))
  ...
  it('unknown id → no dispatch, state unchanged', () => {
    ...
    store.dispatch(commitClipoutResize({ id: 'no-such-id', inBeatTime: 10, outBeatTime: 18, altKey: false }))
...
describe('commitClipoutPan', () => {
  ...
  it('anchorLock=true, altKey=false → anchors TRANSLATE by delta', () => {
    ...
    store.dispatch(commitClipoutPan({ id: 'r', inBeatTime: 15, outBeatTime: 35, altKey: false }))
  ...
  it('anchorLock=false, altKey=true → Alt flips effectiveAnchorLock to true; anchors TRANSLATE', () => {
    ...
    store.dispatch(commitClipoutPan({ id: 'r', inBeatTime: 15, outBeatTime: 35, altKey: true }))
  ...
  it('delta < 1e-9 → no anchor translate dispatch even when anchorLock=true', () => {
    ...
    store.dispatch(commitClipoutPan({ id: 'r', inBeatTime: 10, outBeatTime: 30, altKey: false }))

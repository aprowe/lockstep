...
FFmpeg and ffprobe must be on `PATH` for dev. For packaged releases they're bundled as `externalBin`. See [CLAUDE.md](./CLAUDE.md) for a tour of the codebase — command surface, constraint pipeline, and the warp pipeline.

  ...
  return (
    <div className="about-overlay" onClick={onClose}>
      <div className="about-dialog" onClick={e => e.stopPropagation()}>
        <button className="about-dialog__close" onClick={onClose} title="Close" aria-label="Close">✕</button>
        <div className="about-dialog__mark"><LockstepMark size={64} /></div>
        ...
        <a
          ...
          href={REPO_URL}
          onClick={e => { e.preventDefault(); openExternal(REPO_URL) }}
        >

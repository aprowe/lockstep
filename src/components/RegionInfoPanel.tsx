...
export default function RegionInfoPanel({
    ...
    const effectiveInBeat = effectiveBounds?.inBeatTime ?? activeRegion?.inBeatTime ?? 0;
    const effectiveOutBeat = effectiveBounds?.outBeatTime ?? activeRegion?.outBeatTime ?? duration;
    const beatSpan = activeRegion ? effectiveOutBeat - effectiveInBeat : duration;
    ...
    const applyBeatCount = (n: number) => {
        ...
        if (outLinked) {
            ...
            onUpdateRegionBeatTimes(
                activeRegion.id,
                effectiveBounds?.inBeatTime ?? activeRegion.inBeatTime,
                newOutBeat,
            );
        }
    };
    ...
    const commitIn = () => {
        if (!activeRegion || !onUpdateRegionInOut) {
            setEditingIn(false);
            return;
        }
            ...
            <div className="rip__body">
                    ...
                    <div className="rip__name">
                        {editingName ? (
                            <input
                                ...
                                onBlur={() => {
                                    if (nameInput.trim())
                                        onRename?.(activeRegion.id, nameInput.trim());
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        setNameInput(activeRegion.name);
                                        setEditingName(true);
                                    }}
                                    title="Rename clip"
                                >
                ...
                {activeRegion && (
                    <div className="rip__grid">
                        ...
                        <div
                            className="rip__field rip__field--bpm"
                            title={
                                altHeld
                                    ? "Alt: stretch mode — length rescales"
                                    : "Enter BPM (hold Alt to stretch)"
                            }
                        >
                            <input
                                ...
                                onBlur={(e) => {
                                    ...
                                    const stretch =
                                        (e.nativeEvent as MouseEvent).altKey ?? altHeldRef.current;
                            ...
                            {activeRegion && (
                                <button
                                    ...
                                    title={
                                        lock === "bpm"
                                            ? "BPM locked — resize changes beats"
                                            : "Click to lock BPM"
                                    }
                                >
                                    {lock === "bpm" ? (
                        ...
                        <div
                            className="rip__field rip__field--beats"
                            title={
                                altHeld
                                    ? "Alt: stretch mode — length rescales"
                                    : "Enter beats (hold Alt to stretch)"
                            }
                        >
                            {activeRegion ? (
                                <>
                                    <input
                                        ...
                                        onBlur={(e) => {
                                            const stretch =
                                                (e.nativeEvent as MouseEvent).altKey ??
                                                altHeldRef.current;
                                            altHeldRef.current = false;
                                            setAltHeld(false);
                                            commitBeats(stretch);
                                    ...
                                    <button
                                        ...
                                        title={
                                            lock === "beats"
                                                ? "Beats locked — resize changes BPM"
                                                : "Click to lock beats"
                                        }
                                    >
                                        {lock === "beats" ? (
                        ...
                        <div className="rip__row">
                            ...
                            {editingIn ? (
                                ...
                                <span
                                    ...
                                    onClick={() => {
                                        setInInput(formatTimecode(liveIn));
                                        setEditingIn(true);
                                    }}
                                    title="Click to edit"
                                >
                        ...
                        <div className="rip__row">
                            ...
                            {editingOut ? (
                                ...
                                <span
                                    className="rip__value rip__value--editable"
                                    onClick={() => {
                                        setOutInput(formatTimecode(liveOut));
                                        setEditingOut(true);
                                    }}
                                    title="Click to edit"
                                >
                        ...
                        <div className="rip__row">
                            ...
                            {editingDur ? (
                                ...
                                <span
                                    className="rip__value rip__value--editable"
                                    onClick={() => {
                                        setDurInput(formatTimecode(liveOut - liveIn));
                                        setEditingDur(true);
                                    }}
                                    title="Click to edit"
                                >

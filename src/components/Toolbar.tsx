...
export default function Toolbar({
    ...
    const onSetInRef = useRef(onSetIn);
    onSetInRef.current = onSetIn;
    const onSetOutRef = useRef(onSetOut);
    onSetOutRef.current = onSetOut;
            ...
            <div className="tb-group tb-group--center tb-group--playback">
                ...
                <div className="tb-time">
                    <div className="tb-time__clock">
                        <span data-layout-id="play-time" className="tb-time__current">
                            {fmt(displayTime)}
                        </span>

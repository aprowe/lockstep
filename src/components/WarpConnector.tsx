...
const WarpConnector = forwardRef<HTMLDivElement, WarpConnectorProps>(function WarpConnector(
    {
        segments,
        view,
        origDuration,
    ...
    return (
        <div className="warp-connector-wrap">
            <div className="warp-connector__rail-cell">{railLabel ?? null}</div>
            <div ref={setRefs} className="warp-connector">
              ...
              --space-warp). Intensity (alpha + width) encodes selection. */}
                    {segments.slice(1).map((seg, i) => {
                        ...
                        const atClipOut =
                            clipOut !== undefined && Math.abs(origTime - clipOut) < 1e-3;
                        ...
                        return (
                            <line
                                ...
                                className={
                                    linked
                                        ? "warp-connector__line warp-connector__line--linked"
                                        : "warp-connector__line warp-connector__line--unlinked"
                                }
                                strokeOpacity={alpha}
                            ...
                            (() => {
                                ...
                                return (origX >= -5 && origX <= 105) ||
                                    ...
                                    <line
                                        ...
                                        style={
                                            boundaryColor ? { stroke: boundaryColor } : undefined
                                        }
                                        vectorEffect="non-scaling-stroke"
                                    />
                                ) : null;

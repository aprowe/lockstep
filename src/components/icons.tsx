...
export function IconCreateRegion({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <rect x="5" y="3" width="14" height="18" fill="currentColor" fillOpacity="0.12" stroke="none" />
...
export function IconLockClosed({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <rect x="4" y="13" width="16" height="9" rx="2" fill="currentColor" fillOpacity="0.9" stroke="none" />
    </svg>
  );
}
...
export function IconRename({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M17,3 a2.12,2.12 0 0 1 3,3 L7,19 L3,21 L5,17 Z" fill="currentColor" fillOpacity="0.12" />
      <path d="M15,5 L19,9" />
    </svg>
  );
}
...
export function IconThumbNone({ size = 14, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeLinejoin="round" {...props}>
      <rect x="1" y="3.5" width="14" height="9" rx="0.8" strokeWidth="1.2" strokeDasharray="2 1.5" strokeOpacity="0.65" />
    </svg>
  );
}

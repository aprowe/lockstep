 ...
 *
 * where S is the slice region ID, generated by `videoThunks` and shaped like
 * `region_<timestamp>_<i>_<xxx>`.
 *
 ...
 * discriminated `EntityKind` so lasso / selection logic can split entities
 * by prefix without ad-hoc string checks.
 */

...
export const selectConstraintGraph = createSelector(
  ...
  (origAnchors, beatAnchors, regions, lockMode, anchorLock, anchorLockGestureOverride, activeRegionId, lists, dragCtx, videoPath, cutsByPath, userCutsByPath): ConstraintState => {
    ...
    return buildGraphFromSlice(
      ...
      extractDragCtxFromSlice({ dragCtx }),
    )
  },
)
